...
# $Id: swfmill.mpl,v 1.1 2011/03/23 RyoIwahase Exp $
# @update 2011/04/26
...
perl  -i -pe 's/\r//g' c.txt
perl  -i -pe 's/\r//g' csw_f.txt
...
#print __LINE__, ">>>>>>>>", $joined_xmlfile, "\n";
#print __LINE__, ">>>>>>>>", $converted_swffile, "\n";
...
#=pod
            ...
            0 != $ret ? print "\n", __LINE__, " failed file: ", $converted_swffile : print "=";
#            print "\n", __LINE__, " failed file: ", $converted_swffile if 0 != $ret;
...
>>>>>>> 83809fd0af4f95992b1a9c61cf6ef48f277303e8
